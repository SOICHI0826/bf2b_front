...
export class Program {
  ...
  constructor(gl, vertexShaderString, fragmentShaderString) {
    ...
    gl.attachShader(this.program, utils.getShader(gl, 'vertex', vertexShaderString));
    gl.attachShader(this.program, utils.getShader(gl, 'fragment', fragmentShaderString));
