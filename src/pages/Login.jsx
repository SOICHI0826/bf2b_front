        ...
        <Box className={styles.rightContainer} w='100%'>
          ...
          <Box h='70%'>
            <Box ml='35%' border='1px' borderColor='#000000' borderRadius='5%' w='30%' h='580px'>
              <Heading mt='20%' as='h3' size='lg' fontSize='36px' textAlign='center'>Login Form</Heading>
              ...
              <Center>
              <Button mt='15%' size='lg' bg='#1D71AD' color='white' onClick={handleNavMain}>Login</Button>
              </Center>
            </Box>
          </Box>
          <Footer />
